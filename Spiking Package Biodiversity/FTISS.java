...
public class FTISS {
	...
	public static void main(String[] args) {
		...
		params.add(new String("OTUs_trunc_400_quality_10_mee_1.5_radOrMinNum_99_minAbundance_2_clustering"));
		params.add(new String("OTUs_trunc_375_quality_10_mee_2.0_radOrMinNum_99_minAbundance_2_clustering"));
		params.add(new String("OTUs_trunc_400_quality_10_mee_1.0_radOrMinNum_99_minAbundance_1_clustering"));
		params.add(new String("OTUs_trunc_375_quality_10_mee_1.5_radOrMinNum_99_minAbundance_1_clustering"));
		params.add(new String(""));
		params.add(new String("OTUs_trunc_400_quality_10_mee_1.5_radOrMinNum_100_minAbundance_2_clustering"));
		params.add(new String("OTUs_trunc_375_quality_10_mee_2.0_radOrMinNum_100_minAbundance_2_clustering"));
		params.add(new String("OTUs_trunc_350_quality_10_mee_2.5_radOrMinNum_100_minAbundance_2_clustering"));
		params.add(new String("OTUs_trunc_400_quality_10_mee_1.0_radOrMinNum_100_minAbundance_1_clustering"));
		params.add(new String(""));
		params.add(new String("OTUs_trunc_375_quality_10_mee_1.5_radOrMinNum_8_minAbundance_2_denoising"));
		params.add(new String("OTUs_trunc_375_quality_10_mee_3.0_radOrMinNum_8_minAbundance_1_denoising"));
		params.add(new String("OTUs_trunc_400_quality_10_mee_2.0_radOrMinNum_8_minAbundance_2_denoising"));
		params.add(new String("OTUs_trunc_400_quality_10_mee_2.5_radOrMinNum_8_minAbundance_1_denoising"));
		params.add(new String(""));
		...
		String outputFileName = rootDirectory + "SpikingResultFull"+ iterationCompleted + "-" + taxon +".csv";
		try{
