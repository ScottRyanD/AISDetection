...
for (( j=$4; j < 51; j++ )) #sequences spiked in
do
	if [ ! -f SpikingResultFull${j}-${3}.csv ]; then	#file doesn't exist
		...
		do
			...
			./cluster_runner.sh CompleteSample${i}-${j}-${3} "400" "10" "2.5" "99" "1" "clustering" $i
			./cluster_runner.sh CompleteSample${i}-${j}-${3} "375" "10" "3.0" "99" "1" "clustering" $i
			./cluster_runner.sh CompleteSample${i}-${j}-${3} "400" "10" "3.0" "99" "2" "clustering" $i
			./cluster_runner.sh CompleteSample${i}-${j}-${3} "375" "10" "2.5" "99" "2" "clustering" $i
		
			./cluster_runner.sh CompleteSample${i}-${j}-${3} "400" "10" "2.5" "100" "2" "clustering" $i
			./cluster_runner.sh CompleteSample${i}-${j}-${3} "375" "10" "2.0" "100" "2" "clustering" $i
			./cluster_runner.sh CompleteSample${i}-${j}-${3} "400" "10" "1.5" "100" "1" "clustering" $i
			./cluster_runner.sh CompleteSample${i}-${j}-${3} "375" "10" "2.5" "100" "1" "clustering" $i
		
			./denoise_runner.sh CompleteSample${i}-${j}-${3} "400" "10" "3.0" "2" "2" "denoising" $i
			./denoise_runner.sh CompleteSample${i}-${j}-${3} "400" "10" "2.5" "2" "1" "denoising" $i
			./denoise_runner.sh CompleteSample${i}-${j}-${3} "375" "10" "3.0" "2" "1" "denoising" $i
			./denoise_runner.sh CompleteSample${i}-${j}-${3} "375" "10" "2.5" "2" "2" "denoising" $i
