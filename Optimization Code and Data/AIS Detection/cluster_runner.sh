...
usearch -fastq_filter ${1}${8}.fq -fastq_trunclen $2 -fastq_truncqual $3  -fastq_maxee $4  -fastaout filtered_${1}_${2}_${3}_${4}_${5}_${6}-${7}${8}.fa
...
# cluster these samples
echo "Clustering with radius $5"
if [ "$5" = "100" ]; then
	usearch -cluster_smallmem sorted_${1}_${2}_${3}_${4}_${5}_${6}-${7}${8}.fa -sortedby size -id 1.0 -centroids ${1}_${2}_${3}_${4}_${5}_${6}-${7}${8}_otus.fa
else
	usearch -cluster_smallmem sorted_${1}_${2}_${3}_${4}_${5}_${6}-${7}${8}.fa -sortedby size -id 0.$5 -centroids ${1}_${2}_${3}_${4}_${5}_${6}-${7}${8}_otus.fa
fi
...
#mkdir OTUs_trunc_${2}_quality_${3}_mee_${4}_rad_${5}_no_singles_CLEANED
...
#mv ${1}-${7}_nonchimeric_otus.fa /work/nrap1125/Ryan/CAISN/ClusteringOptimization/OTUs_trunc_${2}_quality_${3}_mee_${4}_rad_${5}_no_singles_CLEANED/${1}_nonchimeric_otus.fa
