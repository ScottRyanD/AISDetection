...
public class Program {
	...
	public static void main(String[] args) {
		...
		FileWriter fstream;
		try {
			filenameout = "/work/nap_9022/Ryan/CAISN/2017Optimization/OTUCounts_" + length + "_" + qFilter + "_" + mee + "_" + radiusOrNMA + "_" + minAbundance + "_" + clusteringOrNR +  ".csv";
			...
			for (int i = 0; i < 100; i++){
			    ...
			    String filenameOTUs = "/work/nap_9022/Ryan/CAISN/2017Optimization/OptimizationSample" + "_" + length + "_" + qFilter + "_" + mee + "_" + radiusOrNMA + "_" + minAbundance + "-" + clusteringOrNR + i + "_otus.fa"; //gotta get the OTUs
		        ...
		        for(String OTU: OTUs){ //iterate through each OTU
		        	...
		        	String fileNameCorrect = "/work/nap_9022/Ryan/CAISN/BLASTNew/BLASTCache" + taxon + length + "CorrectSequences.txt";	//blast cache correct sequences
					String fileNameAmbiguous = "/work/nap_9022/Ryan/CAISN/BLASTNew/BLASTCache" + taxon + length + "AmbiguousSequences.txt";	//blast cache ambiguous sequences
					String fileNameIncorrect = "/work/nap_9022/Ryan/CAISN/BLASTNew/BLASTCache" + taxon + length + "IncorrectSequences.txt";	//blast cache incorrect sequences
